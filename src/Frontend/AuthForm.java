...
public class AuthForm extends JFrame {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == loginButton) {
          ...
          if(conn != null)  {
                personnel = personnel.login(usernameField.getText(), lastnameField.getText(), passwordField.getText(), conn);
                if (personnel == null) {
                     JOptionPane.showMessageDialog(this,"Le personnel est introuvable");
                } else {
                        dispose();
                        new Dashboard(personnel,conn);
                }
            }else{
